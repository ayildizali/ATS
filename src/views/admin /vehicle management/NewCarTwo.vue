    ...
    <div class="flex-1">
      ...
      <div class="m-auto flex w-3/4 items-center justify-center">
        <div class="flex items-center justify-between">
          <div class="pr-2">
            <img src="/public/Frame178(1).svg">
            <p class="mt-2 text-primary">Araç</p>
          </div>
          <img class="mb-4" src="/public/Line43(1).svg">
          <div class="pl-2">
      ...
      <div class=" m-auto mt-16 flex w-11/12 items-center justify-between">
        <div class=" ml-32 w-full">
          ...
          <div class="mt-6">
            <p class="pl-5 text-Dark">Araç Edinme Tarihi</p>
            <div class="h-10 w-3/4 rounded-xl border border-Graydarker ">
              <div class="flex items-center ">
                <p class="pl-10 pt-2"></p>
              </div>
      ...
      <div class="m-auto mt-14 flex w-full items-center justify-center">
        <div class=" flex w-10/12 items-center justify-between">
          <button
              ...
              type="button">
            <img class="pr-2 text-white" src="/public/LeftRounded.svg">
