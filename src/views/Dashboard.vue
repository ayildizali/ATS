    ...
    <div class=" m-auto w-12/12 flex items-center justify-between">
        <div class="flex-1">
            ...
            <div class=" flex items-center justify-between w-11/12 h-32 px-2 py4 m-auto text-4xl " >
                <h2 class="  leading-9 text-green-800  ">
                    Araçlarım
                </h2>
                <div class="flex items-center">
                    <nav class="pr-3">
                        <a href="/public">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle text-gray-500 " viewBox="0 0 16 16">
            ...
            <!-- content-->
            <div class="m-auto flex items-center justify-center p-8 text-cyan-700 w-10/12">
                <div class=" flex items-center justify-between text-neutral-900 w-9/12">
                    <p>Plaka</p>
                    <p>Araç Markası</p>
                    <p>Km</p>
                </div>
            ...
            <div class=" m-auto mt-12 bg-gray-50 shadow rounded-2xl h-24 w-10/12">
                <div class="p-8  flex items-center justify-between ">
                    ...
                    <a href="/public">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-arrow-right text-green-700" viewBox="0 0 16 16">
            ...
            <div class=" m-auto mt-12 bg-gray-50 shadow rounded-2xl h-24 w-10/12">
                <div class="p-8 flex items-center justify-between ">
                    <a href="/public">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-3-square-fill" viewBox="0 0 16 16">
            ...
            <div class=" m-auto mt-12 bg-gray-50 shadow rounded-2xl h-24 w-10/12">
                <div class="p-8  flex items-center justify-between ">
                    <a href="/public">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-4-square-fill" viewBox="0 0 16 16">
            ...
            <div class=" m-auto mt-12 bg-gray-50 shadow rounded-2xl h-24 w-10/12">
                <div class="p-8 flex items-center justify-between ">
                    <a href="/public">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-5-square-fill" viewBox="0 0 16 16">
            ...
            <div class=" m-auto mt-12  bg-gray-50 hover:bg-gray-50  shadow rounded-2xl h-24 w-10/12">
                <div class="p-8 flex items-center justify-between  ">
                    <a href="/public">
            ...
            <div class="mt-32 m-auto flex items-center justify-between w-10/12 ">
                <div class="   ">
                    <p class="text-[#717982]">
                        50 sonuç bulundu.
                    </p>
                ...
                <div class=" ">
                    <nav class="flex items-center  ">
                        ...
                        <a href="/public" class="pl-2" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-1-square bg-[#1E724A] rounded  " viewBox="0 0 16 16">
                                <path d="M9.283 4.002V12H7.971V5.338h-.065L6.072 6.656V5.385l1.899-1.383h1.312Z"/>
                                <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2Zm15 0a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2Z"/>
                            </svg>
                        </a>
                        <a href="/public" class="pl-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-2-square" viewBox="0 0 16 16">
