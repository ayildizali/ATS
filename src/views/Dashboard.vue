...
<template>
    <div class=" m-auto flex w-full items-center justify-between">
        <div class="flex-1">
            ...
            <!-- content-->
            <div class="m-auto flex w-10/12 items-center justify-center p-8 text-cyan-700">
                <div class=" flex w-9/12 items-center justify-between text-neutral-900">
                    <p>Plaka</p>
                    <p>Araç Markası</p>
                    <p>Km</p>
                </div>
            ...
            <div class=" m-auto mt-12  h-24 w-10/12  rounded-2xl bg-gray-50 shadow hover:bg-gray-50">
                <div class="flex items-center justify-between p-8  ">
                    <a href="/public">
            ...
            <div class="m-auto mt-32 flex w-10/12 items-center justify-between ">
                <div class="   ">
                    <p class="text-[#717982]">
                        50 sonuç bulundu.
                    </p>
                ...
                <div class=" ">
                    <nav class="flex items-center  ">
                        ...
                        <a href="/public" class="pl-2" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-1-square rounded bg-[#1E724A]  " viewBox="0 0 16 16">
